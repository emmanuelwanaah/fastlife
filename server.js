...
const { validateAndHashPassword } = require('./utils/passwords'); // Password validator
const { sendVerificationCode } = require('./utils/emails');       // Email sender
...
(async () => {
  try {
    db = await mysql.createConnection({
      ...
      port: 48849,
      user: 'root',
      password: 'bUkrwAkwybYVxeTDkYQszxOOGzxcqnYz',
      database: 'railway',
